...
const products = [
  {
    name: "Nº57 — Holz & Vanille",
    note: "Warm, holzig, cremige Vanille. Hält 8–10 Stunden auf der Haut.",
    price: "€ 32,00",
    badges: ["Bestseller"],
  },
  {
    name: "Nº22 — Neroli & Bergamotte",
    note: "Frisch, sonnig, leicht floral. Für helle Tage und klare Köpfe.",
    price: "€ 32,00",
    badges: ["Neu im Sortiment"],
  },
  {
    name: "Nº09 — Amber & Moschus",
    note: "Sinnlich, weich, langanhaltend. Der Duft für besondere Abende.",
    price: "€ 34,00",
    badges: ["Limitiert"],
  },
];
          ...
          <div className="md:col-span-5">
            <Reveal delay={0.1}>
              <p className="text-pretty font-light leading-relaxed text-mushroom">
                Keine Superlative — konkrete Empfehlungen. Sag mir, was du magst,
                und ich finde den Duft, der zu dir passt und wirklich bleibt.
              </p>
            </Reveal>
          </div>
        </div>
              ...
              <article className="group flex h-full flex-col border border-greige/25 bg-ivory/40 transition-colors duration-500 hover:border-clay/30">
                <div className="relative">
                  ...
                  <div className="absolute left-3 top-3 flex flex-wrap gap-2">
                    {p.badges.map((b) => (
                      <span key={b} className="badge bg-cream/80 backdrop-blur-sm">
                        {b}
                      </span>
                    ))}
                  </div>
                ...
                <div className="flex flex-1 flex-col p-6">
                  <p className="mono-label text-clay/70">Parfum · Chogan</p>
        ...
        <Reveal delay={0.1}>
          <div className="mt-14 flex flex-col items-start gap-5 sm:flex-row sm:items-center">
            ...
            <span className="mono-label text-clay/70">
              Kostenlos · unverbindlich · per WhatsApp oder Zoom
            </span>
          </div>
        </Reveal>
      </div>
